describe("About Arrays", function() {
  ...
  it("should slice arrays", function () {
    ...
    expect(array.slice(2, 2)).toEqual("butter butter");
    expect(array.slice(2, 20)).toEqual("butter", -1);
    expect(array.slice(3, 0)).toEqual("jelly peanut");
    expect(array.slice(3, 100)).toEqual("jelly", -1);
    expect(array.slice(5, 1)).toEqual(-1, "butter");
  });
